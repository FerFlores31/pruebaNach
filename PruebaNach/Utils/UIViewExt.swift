...
let colorBlu2 = UIColor(red: 0.13, green: 0.61, blue: 0.86, alpha: 1.00)

let colorBlu = UIColor(red: 0.08, green: 0.39, blue: 0.58, alpha: 1.00)
let colorGra = UIColor(red: 0.95, green: 0.95, blue: 0.95, alpha: 1.00)

let colorRed = UIColor(red: 1.00, green: 0.35, blue: 0.37, alpha: 1.00)
let colorGreen = UIColor(red: 0.40, green: 0.69, blue: 0.67, alpha: 1.00)
let colorGreen2 = UIColor(red: 0.05, green: 0.47, blue: 0.53, alpha: 1.00)
let colorBlue = UIColor(red: 0.35, green: 0.78, blue: 1.00, alpha: 1.00)
let colorG = UIColor(red: 0.82, green: 0.85, blue: 0.35, alpha: 1.00)
